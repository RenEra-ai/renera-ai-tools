...
> **Note:** This skill is designed for the bitwize-music genre library ecosystem. It creates genre documentation files and updates mastering presets. If no `genres/` directory exists in your project, create one or adapt the output paths.

## Your Task

Create a new genre README.md for a genre library at `${CLAUDE_PLUGIN_ROOT}/genres/` (or the project's genre directory).

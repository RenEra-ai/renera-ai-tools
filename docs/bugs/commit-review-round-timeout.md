...
**Status:** Fix shipped in codex-claude **1.8.13** (structural fix landed 1.8.9; hardened through 1.8.10–1.8.13 over four review rounds) — pending live verification (see [Resolution](#resolution))
**Reported:** 2026-07-20
...
through **1.8.13** over four follow-up Codex review rounds
(`docs/plans/2026-07-20-detached-review-hardening-1811.md`,
`docs/plans/2026-07-20-detached-review-hardening-1812.md`,
`docs/plans/2026-07-20-detached-review-hardening-1813.md`). The reported symptom is real and

...
name: codex-review
description: >-
  Get an independent Codex (GPT-5.x) review of the current changes. Dispatches the codex-reviewer
...
Dispatch the **codex-reviewer** subagent (via the Task tool) with a precise brief: the files/scope

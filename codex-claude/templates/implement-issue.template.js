...
const PRE = { type: 'object', additionalProperties: false, required: ['ok', 'reason', 'issue_state', 'issue_title', 'base_sha', 'branch'], properties: { ok: { type: 'boolean' }, reason: { type: 'string' }, issue_state: { type: 'string' }, issue_title: { type: 'string' }, base_sha: { type: 'string' }, branch: { type: 'string' } } }
...
if (DRY_RUN) { report.terminal = 'dry_run_ok'; return report }
